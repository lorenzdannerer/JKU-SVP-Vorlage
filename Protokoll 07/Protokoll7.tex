...
\input{../Einstellungen.tex}            % Eistellungen.tex initial einrichten

\addbibresource{Quellen.bib}
\addbibresource{../Allgemeine_Quellen.bib}
...
% ------------------------------------------------------------------------------
\svpSetup{
    tag    = {01. März 2026},                % gib das Datum des Praktikums ein
    titel  = {XX - Thema}    % "<Kurzbez.> - <Name des Themas>"
}
...
\include{./Kapitel/Didaktische_Basisinformationen}
